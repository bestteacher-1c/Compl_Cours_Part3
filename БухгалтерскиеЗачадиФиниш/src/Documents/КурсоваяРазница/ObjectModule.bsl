Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		ОстатокДт = ВыборкаДетальныеЗаписи.СуммаОстатокДт;
		ОстатокКт = ВыборкаДетальныеЗаписи.СуммаОстатокКт;
		
		ОстатокПоНовомуКурсуДт = ВалютаОстатокДт * ВыборкаДетальныеЗаписи.Курс;
		ОстатокПоНовомуКурсуРублиКт = ВалютаОстатокКт * ВыборкаДетальныеЗаписи.Курс;
		
		КурсоваяРазницаДт = ОстатокДт - ОстатокПоНовомуКурсуДт;
		КурсоваяРазницаКт = ОстатокКт - ОстатокПоНовомуКурсуРублиКт;

		Если (ВалютаОстатокДт > 0 и КурсоваяРазницаДт > 0) Или (ВалютаОстатокКт >0 и КурсоваяРазницаКт < 0)  Тогда
		...
		ИначеЕсли (ВалютаОстатокКт > 0 и КурсоваяРазницаКт > 0) Или (ВалютаОстатокДт >0 и КурсоваяРазницаДт < 0) Тогда
