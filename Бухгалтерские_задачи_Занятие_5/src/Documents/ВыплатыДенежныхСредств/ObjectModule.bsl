...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	БухгалтерияНаСервере.ЗаполнитьСубконтоСтороныПроводки(Движение,1,КорСубконто1,"Дт");
	БухгалтерияНаСервере.ЗаполнитьСубконтоСтороныПроводки(Движение,2,КорСубконто2,"Дт");
//	ОбщийМодульНаСервере.ЗаполнитьВалютуСтороныПроводки(Движение,Валюта, Сумма,"Дт");
	...
	БухгалтерияНаСервере.ЗаполнитьСубконтоСтороныПроводки(Движение,"ДвиженияДенежныхСредств",ДвижениеДенежныхСредств,"Кт");
...
Процедура ИзменитьТекстЗапроса(Запрос, Счет)
	...
	ДанныеСчета = НаСервереМожноВызватьСКлиента.ПолучитьСвойствоСчета(Счет);
